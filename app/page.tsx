...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // ==========================================
    const nodesG2 = [
      // Troncal Principal (Ruta base)
      { from: 'Montería', to: 'Planeta Rica', label: '50 km' },
      { from: 'Planeta Rica', to: 'Buenavista', label: '40 km' },
      { from: 'Buenavista', to: 'La Apartada', label: '25 km' },
      { from: 'La Apartada', to: 'Caucasia', label: '25 km' },
      { from: 'Caucasia', to: 'Tarazá', label: '65 km' },
      { from: 'Tarazá', to: 'Valdivia', label: '45 km' },
      { from: 'Valdivia', to: 'Yarumal', label: '45 km' },
      { from: 'Yarumal', to: 'Santa Rosa de Osos', label: '45 km' },
      { from: 'Santa Rosa de Osos', to: 'Donmatías', label: '25 km' },
      { from: 'Donmatías', to: 'Bello', label: '40 km' },
      { from: 'Bello', to: 'Medellín', label: '10 km' },

      // Densificación Topológica: Conexiones transversales y redundancias
      { from: 'Montería', to: 'Buenavista', label: '70 km' },
      { from: 'Planeta Rica', to: 'La Apartada', label: '55 km' },
      { from: 'La Apartada', to: 'Montelíbano', label: '25 km' },
      { from: 'Montelíbano', to: 'Puerto Libertador', label: '40 km' },
      { from: 'Caucasia', to: 'Montelíbano', label: '60 km' },
      { from: 'Puerto Libertador', to: 'Tarazá', label: '80 km' }, 
      { from: 'Valdivia', to: 'Anorí', label: '70 km' },
      { from: 'Anorí', to: 'Amalfi', label: '50 km' },
      { from: 'Amalfi', to: 'Yolombó', label: '45 km' },
      { from: 'Yolombó', to: 'Cisneros', label: '30 km' },
      { from: 'Cisneros', to: 'Santo Domingo', label: '25 km' },
      { from: 'Santo Domingo', to: 'Donmatías', label: '40 km' },
      { from: 'Amalfi', to: 'Santo Domingo', label: '60 km' }, 
      { from: 'Anorí', to: 'Yarumal', label: '65 km' }, 
      { from: 'Yarumal', to: 'Angostura', label: '35 km' },
      { from: 'Angostura', to: 'Guadalupe', label: '20 km' },
      { from: 'Guadalupe', to: 'Gómez Plata', label: '25 km' },
      { from: 'Gómez Plata', to: 'Carolina del Príncipe', label: '15 km' },
      { from: 'Carolina del Príncipe', to: 'Santa Rosa de Osos', label: '35 km' },
      { from: 'Donmatías', to: 'San Pedro de los Milagros', label: '30 km' },
      { from: 'San Pedro de los Milagros', to: 'Bello', label: '20 km' },
      { from: 'San Pedro de los Milagros', to: 'Medellín', label: '35 km' },
      { from: 'Donmatías', to: 'Girardota', label: '35 km' },
      { from: 'Girardota', to: 'Copacabana', label: '10 km' },
      { from: 'Copacabana', to: 'Bello', label: '5 km' },
      { from: 'Copacabana', to: 'Medellín', label: '15 km' }
    ];

    const edgesG2 = [
      // Troncal Principal Occidente-Urabá
      { from: 'Montería', to: 'Canalete', label: '50 km' },
      { from: 'Canalete', to: 'Puerto Escondido', label: '30 km' },
      { from: 'Puerto Escondido', to: 'Los Córdobas', label: '25 km' },
      { from: 'Los Córdobas', to: 'Arboletes', label: '40 km' },
      { from: 'Arboletes', to: 'San Pedro de Urabá', label: '45 km' },
      { from: 'San Pedro de Urabá', to: 'Turbo', label: '60 km' },
      { from: 'Turbo', to: 'Apartadó', label: '30 km' },
      { from: 'Apartadó', to: 'Carepa', label: '20 km' },
      { from: 'Carepa', to: 'Chigorodó', label: '15 km' },
      { from: 'Chigorodó', to: 'Mutatá', label: '45 km' },
      { from: 'Mutatá', to: 'Dabeiba', label: '80 km' },
      { from: 'Dabeiba', to: 'Uramita', label: '45 km' },
      { from: 'Uramita', to: 'Cañasgordas', label: '40 km' },
      { from: 'Cañasgordas', to: 'Giraldo', label: '30 km' },
      { from: 'Giraldo', to: 'Santa Fé de Antioquia', label: '45 km' },
      { from: 'Santa Fé de Antioquia', to: 'Sopetrán', label: '20 km' },
      { from: 'Sopetrán', to: 'San Jerónimo', label: '15 km' },
      { from: 'San Jerónimo', to: 'Medellín', label: '55 km' },

      // Densificación Topológica: Rutas alternas y tolerancia a fallos
      { from: 'Montería', to: 'Puerto Escondido', label: '60 km' },
      { from: 'Montería', to: 'Los Córdobas', label: '65 km' },
      { from: 'Arboletes', to: 'Turbo', label: '110 km' },
      { from: 'San Pedro de Urabá', to: 'Apartadó', label: '70 km' },
      { from: 'Turbo', to: 'Carepa', label: '45 km' },
      { from: 'Apartadó', to: 'Chigorodó', label: '35 km' },
      { from: 'Mutatá', to: 'Uramita', label: '100 km' }, 
      { from: 'Dabeiba', to: 'Cañasgordas', label: '65 km' },
      { from: 'Uramita', to: 'Frontino', label: '25 km' },
      { from: 'Uramita', to: 'Peque', label: '55 km' },
      { from: 'Peque', to: 'Buriticá', label: '60 km' },
      { from: 'Frontino', to: 'Abriaquí', label: '35 km' },
      { from: 'Abriaquí', to: 'Urrao', label: '60 km' },
      { from: 'Urrao', to: 'Caicedo', label: '50 km' },
      { from: 'Caicedo', to: 'Santa Fé de Antioquia', label: '45 km' },
      { from: 'Abriaquí', to: 'Santa Fé de Antioquia', label: '65 km' },
      { from: 'Frontino', to: 'Urrao', label: '80 km' },
      { from: 'Cañasgordas', to: 'Buriticá', label: '35 km' },
      { from: 'Buriticá', to: 'Santa Fé de Antioquia', label: '50 km' },
      { from: 'Santa Fé de Antioquia', to: 'San Jerónimo', label: '35 km' },
      { from: 'Sopetrán', to: 'Medellín', label: '50 km' },
      { from: 'San Jerónimo', to: 'Ebéjico', label: '35 km' },
      { from: 'Ebéjico', to: 'Heliconia', label: '30 km' },
      { from: 'Heliconia', to: 'Medellín', label: '40 km' },
      { from: 'Ebéjico', to: 'Medellín', label: '45 km' },
      { from: 'Heliconia', to: 'San Jerónimo', label: '55 km' }
    ];
